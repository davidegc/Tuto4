<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registro.aspx.cs" Inherits="Tuto4.registro" %>
            ...
            <div class="modal-content">
                ...
                <form id="form1" runat="server" class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCURP" runat="server" CssClass="form-control form-text" placeholder="Ingresa un usuario"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtClave" runat="server" CssClass="form-control form-text" placeholder="Ingresa una contraseña" TextMode="Password"></asp:TextBox>
                    ...
                    <asp:LinkButton ID="lnkRegistro" runat="server" OnClick="lnkRegistro_Click" CssClass="form-control btn btn-primary btn-log">
                            <i class='fas fa-save'></i>Registrar
                    </asp:LinkButton>

                    <div class="col-12 forgot">
                        <asp:LinkButton ID="lnkInicio" runat="server" OnClick="lnkInicio_Click" CausesValidation="false">Iniciar Sesión</asp:LinkButton>
                    </div>
